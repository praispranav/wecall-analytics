...
export class CreateEntryDto {
    ...
    UtmAdset: string | null = null;

    @ApiProperty({
        required: false,
        default: null
    })
    UtmAd: string | null = null;
    ...
    @ApiProperty({
        description: "Visitor Id is generated by frontend unique for every visitor. It can be duplicate if same user make call again with same browser.",
        required: false,
        default: null
    })
    ...
    InboundState: string | null = null;

    @ApiProperty({
        required: false,
        default: null
    })
    IcpState: string | null = null;

    @ApiProperty({
        required: false,
        default: null
    })
    IcpZip: string | null = null;
